...
type: ConfigDrift
danger: Low
description: Modifies a key in a ConfigMap or Secret to test configuration reconciliation.
spec_fields:
  - name: resourceType
    type: string
    required: true
    description: "Target resource type: ConfigMap or Secret"
  - name: name
    type: string
    required: true
  ...
  - name: key
    type: string
    required: true
    description: Key within the data map to modify
  - name: value
    type: string
    required: true
    description: Value to set (replaces existing value)
  - name: ttl
    type: duration
    required: false
    default: "300s"
