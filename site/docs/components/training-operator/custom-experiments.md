# training-operator Custom Experiments

This page provides templates for writing custom chaos experiments targeting training-operator.
...
metadata:
  name: training-operator-controller-manager-custom
spec:
  target:
  ...
  injection:
    ...
    parameters:
      labelSelector: app=training-operator-controller-manager
    ttl: "300s"
  hypothesis:
    description: >-
