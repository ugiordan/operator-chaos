# codeflare Custom Experiments

This page provides templates for writing custom chaos experiments targeting codeflare.
...
metadata:
  name: codeflare-operator-manager-custom
spec:
  target:
    operator: codeflare
  ...
  injection:
    ...
    parameters:
      labelSelector: app=codeflare-operator-manager
    ttl: "300s"
  hypothesis:
    description: >-
