# trustyai Custom Experiments

This page provides templates for writing custom chaos experiments targeting trustyai.
...
spec:
  ...
  injection:
    ...
    parameters:
      labelSelector: app=trustyai-service-operator-controller-manager
    ttl: "300s"
  hypothesis:
    description: >-
