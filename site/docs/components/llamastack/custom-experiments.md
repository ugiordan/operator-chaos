# llamastack Custom Experiments

This page provides templates for writing custom chaos experiments targeting llamastack.
...
spec:
  ...
  injection:
    ...
    parameters:
      labelSelector: app=llamastack-controller-manager
    ttl: "300s"
  hypothesis:
    description: >-
